(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const d of a.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&o(d)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();firebase.initializeApp({apiKey:"AIzaSyB9bzvJnQgQTsXajtKmOWXjut4gN9PRsLU",authDomain:"front-report.firebaseapp.com",projectId:"front-report",storageBucket:"front-report.firebasestorage.app",messagingSenderId:"797597961440",appId:"1:797597961440:web:9c975ccf35db6aa1b3d485"});const N=firebase.auth(),me=new firebase.auth.GoogleAuthProvider;me.setCustomParameters({hd:"freightright.com"});let I=null,S=null,ee={};const oe={"Ocean FCL":"#5B86AD","Ocean LCL":"#588B8B","Air LCL":"#D1A677","Road LTL":"#FB923C","Road FTL":"#1e3063",FCL:"#5B86AD",LCL:"#588B8B",LTL:"#D1A677",FTL:"#FB923C"},R=["#818CF8","#34D399","#F472B6","#38BDF8","#FCD34D","#6366F1"],ae=["#1e3063","#73be4b","#5B86AD","#D1A677","#FB923C","#588B8B","#FF4081","#818CF8"],re={open:{bg:"bg-sea-fcl",hex:"#5B86AD",label:"Open"},waiting:{bg:"bg-road-ltl",hex:"#FB923C",label:"Waiting"},resolved:{bg:"bg-accent-green",hex:"#73be4b",label:"Resolved"},archived:{bg:"bg-slate-400",hex:"#9CA3AF",label:"Archived"}},xe="https://app.frontapp.com/open/";function fe(e){const t=new Date,n=new Date(t.getFullYear(),t.getMonth(),t.getDate()),o=s=>new Date(s.getFullYear(),s.getMonth(),s.getDate(),23,59,59,999);switch(e){case"today":return{start:n,end:o(n)};case"yesterday":{const s=new Date(n);return s.setDate(s.getDate()-1),{start:s,end:o(s)}}case"this-week":{const s=new Date(n);return s.setDate(s.getDate()-s.getDay()),{start:s,end:o(n)}}case"last-7":{const s=new Date(n);return s.setDate(s.getDate()-6),{start:s,end:o(n)}}case"last-week":{const s=new Date(n);s.setDate(s.getDate()-s.getDay()-7);const a=new Date(s);return a.setDate(a.getDate()+6),{start:s,end:o(a)}}case"last-month":{const s=new Date(t.getFullYear(),t.getMonth()-1,1),a=new Date(t.getFullYear(),t.getMonth(),0);return{start:s,end:o(a)}}case"last-quarter":{const s=Math.floor(t.getMonth()/3),a=new Date(t.getFullYear(),(s-1)*3,1),d=new Date(t.getFullYear(),s*3,0);return{start:a,end:o(d)}}case"last-year":return{start:new Date(t.getFullYear()-1,0,1),end:o(new Date(t.getFullYear()-1,11,31))};case"ytd":return{start:new Date(t.getFullYear(),0,1),end:o(n)};default:return{start:n,end:o(n)}}}let H=fe("last-7");const te=window.location.hostname==="localhost"?"":"https://front-report.onrender.com",j=()=>`start=${H.start.toISOString()}&end=${H.end.toISOString()}`,k=async(e,t={},n)=>{const o={...t.headers||{}};S&&(o.Authorization=`Bearer ${S}`);const s={...t,headers:o},a=await fetch(te+e,s);if(a.status===401&&!n&&I)return S=await I.getIdToken(!0),k(e,t,!0);if(!a.ok){let d=String(a.status);try{const p=await a.json();p.error&&(d+=": "+p.error)}catch{}throw new Error(d)}return a.json()},C=document.createElement("div");C.id="loadingOverlay";C.className="fixed inset-0 z-[60] bg-background-light/60 backdrop-blur-sm flex items-center justify-center pointer-events-auto transition-opacity duration-200";C.innerHTML=`
  <div class="bg-white rounded-2xl shadow-lg px-8 py-6 flex flex-col items-center gap-3">
    ...
    <span class="text-sm font-semibold text-primary">Loading dashboard…</span>
      ...
      <div class="bg-white dark:bg-background-dark/50 p-4 rounded-xl shadow-sm border border-primary/5 flex flex-col items-center">
        <div class="relative size-20 mb-2">
          <svg class="size-full rotate-[-90deg]" viewBox="0 0 36 36">${p}</svg>
    ...
    </div>`}).join("")}let V=null,Z=null,O=[],D="assigned_conversations",M=!1;function Ae(){const e=[...O];return e.sort((t,n)=>{let o=t[D],s=n[D];return D==="name"?(o=(o||"").toLowerCase(),s=(s||"").toLowerCase(),M?o.localeCompare(s):s.localeCompare(o)):M?o-s:s-o}),e}function Ee(){document.querySelectorAll("th[data-sort]").forEach(e=>{const t=e.querySelector(".sort-arrow");e.dataset.sort===D?t.textContent=M?"↑":"↓":t.textContent=""})}function be(e){e&&(O=e);const t=document.getElementById("teamBody");if(!O||!O.length){t.innerHTML='<tr><td colspan="7" class="px-4 py-6 text-center text-xs text-slate-400">No data</td></tr>';return}const n=Ae();Ee(),t.innerHTML=n.map(o=>{const s=se(o.first_name,o.last_name);return`<tr>
    ...
    </div>`}).join("")}function Ce(e){const t=document.getElementById("mgmtKpiCards");if(!e||!e.current)return;const n=e.current,o=e.previous||{},s=e.mode_breakdown||[],a=e.daily||[],d=l=>Number(l).toLocaleString();function p(l,c,x=!1){if(!c||c===0)return'<span class="text-[10px] text-slate-300 font-medium">—</span>';const L=(l-c)/c*100,w=L>=0,f=x?!w:w;return`<span class="${f?"text-[#73be4b]":"text-red-400"} text-[10px] font-bold bg-${f?"[#73be4b]":"red-400"}/10 px-1.5 py-0.5 rounded">${w?"↑":"↓"} ${Math.abs(L).toFixed(1)}%</span>`}function m(l,c){if(c==null)return'<span class="text-[10px] text-slate-300 font-medium">—</span>';const x=l-c,L=x>=0?"text-[#73be4b]":"text-red-400",w=x>=0?"↑":"↓";return`<span class="${L} text-[10px] font-bold">${w} ${Math.abs(x).toFixed(1)}pp</span>`}function v(l,c){if(a.length<2)return"";const x=a.map(E=>Number(E[l])),L=Math.max(...x,1),w=80,f=34,A=E=>E/(x.length-1)*(w-4)+2,$=E=>f-3-E/L*(f-8),F=x.map((E,K)=>`${A(K)},${$(E)}`).join(" L "),Y=x[x.length-1];return`<svg width="${w}" height="${f}" viewBox="0 0 ${w} ${f}" class="overflow-visible flex-shrink-0">
      <defs><linearGradient id="sg-${l}" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stop-color="${c}" stop-opacity="0.25"/>
        <stop offset="100%" stop-color="${c}" stop-opacity="0"/>
      </linearGradient></defs>
      <path d="M ${F} L ${A(x.length-1)},${f} L ${A(0)},${f} Z" fill="url(#sg-${l})"/>
      <polyline points="${x.map((E,K)=>`${A(K)},${$(E)}`).join(" ")}" fill="none" stroke="${c}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <circle cx="${A(x.length-1)}" cy="${$(Y)}" r="2.5" fill="${c}" stroke="#fff" stroke-width="1.5"/>
    </svg>`}function i(l){const F=Math.PI*22,Y=Math.min(l/100,1)*F;return`<svg width="54" height="30" viewBox="0 0 54 30" class="overflow-visible flex-shrink-0">
    ...
    </svg>`}const u={AIR:"#5B86AD","OCEAN FCL":"#73be4b","OCEAN LCL":"#22c55e",OCEAN:"#3b82f6","ROAD LTL":"#f59e0b","ROAD FTL":"#f97316",ROAD:"#ef4444",Other:"#9CA3AF"},g=s.reduce((l,c)=>l+c.count,0)||1,h=s.length?`
    <div class="flex w-full h-2 rounded-full overflow-hidden gap-px mt-3 mb-2.5">
      ${s.map(l=>`<div style="width:${(l.count/g*100).toFixed(1)}%;background:${u[l.mode]||"#9CA3AF"}" title="${l.mode}: ${d(l.count)}"></div>`).join("")}
    </div>
    <div class="flex flex-wrap gap-x-3 gap-y-1.5">
      ${s.map(l=>`
        <div class="flex items-center gap-1">
          <div class="size-2 rounded-sm flex-shrink-0" style="background:${u[l.mode]||"#9CA3AF"}"></div>
          <span class="text-[9px] text-slate-500">${l.mode}</span>
    ...
    <div class="bg-white dark:bg-background-dark/50 p-4 rounded-xl shadow-sm border border-primary/5">
      <div class="flex items-center justify-between mb-1">
        ...
        ${p(n.total_conversations,o.total_conversations)}
      </div>
    ...
    <div class="bg-white dark:bg-background-dark/50 p-4 rounded-xl shadow-sm border border-primary/5">
      <div class="flex items-center justify-between mb-1">
        ...
        ${p(n.won_conversations,o.won_conversations)}
      </div>
      <div class="flex items-end justify-between">
    ...
    <div class="bg-white dark:bg-background-dark/50 p-4 rounded-xl shadow-sm border border-primary/5">
      <div class="flex items-center justify-between mb-1">
        ...
        ${p(n.lost_conversations,o.lost_conversations,!0)}
      </div>
      <div class="flex items-end justify-between">
    ...
    <div class="bg-white dark:bg-background-dark/50 p-4 rounded-xl shadow-sm border border-primary/5">
    ...
    </div>`}function ve(e){Z=e;const t=document.getElementById("winRateChart"),n=document.getElementById("winRateTooltip");if(t.innerHTML="",!e||!e.length){t.innerHTML='<text x="50%" y="50%" text-anchor="middle" fill="#9CA3AF" font-size="12">No data</text>';return}const o=t.getBoundingClientRect().width||600,s=200;t.setAttribute("viewBox",`0 0 ${o} ${s}`);const a={t:16,r:16,b:32,l:40},d=o-a.l-a.r,p=s-a.t-a.b,m=Math.max(...e.map(r=>Math.max(r.won,r.lost)),1),v=e.length>1?d/(e.length-1):d/2,i=r=>a.l+r*v,u=r=>a.t+p-r/m*p,g="http://www.w3.org/2000/svg";for(let r=0;r<=4;r++){const b=a.t+p/4*r,l=document.createElementNS(g,"line");Object.entries({x1:a.l,x2:o-a.r,y1:b,y2:b,stroke:"#F3F4F6","stroke-width":1}).forEach(([x,L])=>l.setAttribute(x,L)),t.appendChild(l);const c=document.createElementNS(g,"text");c.setAttribute("x",a.l-6),c.setAttribute("y",b+3),c.setAttribute("text-anchor","end"),c.setAttribute("fill","#9CA3AF"),c.setAttribute("font-size","9"),c.textContent=Math.round(m-m/4*r),t.appendChild(c)}const h=Math.max(1,Math.floor(e.length/7));e.forEach((r,b)=>{if(b%h!==0&&b!==e.length-1)return;const l=document.createElementNS(g,"text");l.setAttribute("x",i(b)),l.setAttribute("y",s-6),l.setAttribute("text-anchor","middle"),l.setAttribute("fill","#9CA3AF"),l.setAttribute("font-size","9");const c=new Date(r.day+"T00:00:00");l.textContent=c.toLocaleDateString("en-US",{month:"short",day:"numeric"}),t.appendChild(l)});function y(r,b,l){let c=`M ${i(0)} ${u(e[0][r])}`;for(let f=1;f<e.length;f++)c+=` L ${i(f)} ${u(e[f][r])}`;c+=` L ${i(e.length-1)} ${a.t+p} L ${i(0)} ${a.t+p} Z`;const x=document.createElementNS(g,"path");x.setAttribute("d",c),x.setAttribute("fill",l),t.appendChild(x);let L=`M ${i(0)} ${u(e[0][r])}`;for(let f=1;f<e.length;f++)L+=` L ${i(f)} ${u(e[f][r])}`;const w=document.createElementNS(g,"path");w.setAttribute("d",L),w.setAttribute("fill","none"),w.setAttribute("stroke",b),w.setAttribute("stroke-width","2"),t.appendChild(w),e.forEach((f,A)=>{const $=document.createElementNS(g,"circle");$.setAttribute("cx",i(A)),$.setAttribute("cy",u(f[r])),$.setAttribute("r","3"),$.setAttribute("fill",b),$.setAttribute("stroke","#fff"),$.setAttribute("stroke-width","1.5"),t.appendChild($)})}y("won","#73be4b","rgba(115,190,75,0.08)"),y("lost","#f87171","rgba(248,113,113,0.08)"),e.forEach((r,b)=>{const l=document.createElementNS(g,"rect");l.setAttribute("x",i(b)-v/2),l.setAttribute("y",a.t),l.setAttribute("width",v),l.setAttribute("height",p),l.setAttribute("fill","transparent");const c=r.won+r.lost>0?(r.won/(r.won+r.lost)*100).toFixed(1):"—";l.addEventListener("mouseenter",()=>{n.classList.remove("hidden");const x=new Date(r.day+"T00:00:00");n.innerHTML=`<strong>${x.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})}</strong><br>Won: ${r.won} &nbsp; Lost: ${r.lost} &nbsp; Total: ${r.total}<br>Win Rate: ${c}%`}),l.addEventListener("mousemove",x=>{const L=t.closest(".relative").getBoundingClientRect();n.style.left=x.clientX-L.left+12+"px",n.style.top=x.clientY-L.top-40+"px"}),l.addEventListener("mouseleave",()=>n.classList.add("hidden")),t.appendChild(l)})}function Te(e){const t=document.getElementById("freightBreakdown");if(!e||!e.directions){t.innerHTML='<div class="text-xs text-slate-400 text-center py-4">No data</div>';return}const{grand_total:n,no_direction_total:o,directions:s}=e,a=i=>Number(i).toLocaleString(),d=(i,u)=>u>0?(i/u*100).toFixed(1):"0.0",p=s.map(i=>{const u=d(i.total,n),g=d(i.won,i.won+i.lost),h=d(i.lost,i.won+i.lost);return`
      <div class="bg-slate-50 dark:bg-slate-800/60 rounded-lg p-3 flex flex-col gap-1 min-w-0">
        ...
        <div class="text-[10px] text-slate-400">${u}% of total</div>
      ...
      </div>`}).join(""),m=s.flatMap(i=>i.modes.map(u=>{const g=d(u.total,i.total),h=d(u.won,u.won+u.lost);return`<tr class="border-t border-slate-100 dark:border-slate-700/50">
        <td class="py-1.5 px-2 text-[11px] text-slate-500">${i.label}</td>
        <td class="py-1.5 px-2 text-[11px] font-semibold text-slate-700 dark:text-slate-300">${u.label}</td>
        <td class="py-1.5 px-2 text-[11px] text-right text-slate-700 dark:text-slate-300">${a(u.total)}</td>
        <td class="py-1.5 px-2 text-[11px] text-right text-slate-400">${g}%</td>
        <td class="py-1.5 px-2 text-[11px] text-right text-[#73be4b] font-semibold">${a(u.won)}</td>
        <td class="py-1.5 px-2 text-[11px] text-right text-red-400 font-semibold">${a(u.lost)}</td>
...
`),u=new Blob([i],{type:"text/csv;charset=utf-8;"}),g=document.createElement("a");g.href=URL.createObjectURL(u),g.download="management-win-rate.csv",g.click(),URL.revokeObjectURL(g.href);return}const o=t!=="pending-replies";let s=`${te}/api/download-conversations?type=${t}`;o&&(s+=`&${j()}`);const a=await fetch(s,{headers:n});if(!a.ok)throw new Error(a.status);const d=await a.blob(),p=document.createElement("a");p.href=URL.createObjectURL(d),p.download=e.dataset.filename||`${t}.csv`,p.click(),URL.revokeObjectURL(p.href)}catch(o){console.error("Download error:",o)}})});const Q=document.getElementById("datePreset"),le=document.getElementById("customRange");Q.addEventListener("change",()=>{if(Q.value==="custom"){le.classList.remove("hidden");return}le.classList.add("hidden"),H=fe(Q.value),P()});document.getElementById("applyCustom").addEventListener("click",()=>{const e=document.getElementById("customStart").value,t=document.getElementById("customEnd").value;e&&t&&(H={start:new Date(e+"T00:00:00"),end:new Date(t+"T23:59:59.999")},P())});document.querySelectorAll("th[data-sort]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.sort;D===t?M=!M:(D=t,M=t==="name"),be()})});var pe;(pe=document.getElementById("themeLight"))==null||pe.addEventListener("click",()=>{document.documentElement.classList.remove("dark")});var ue;(ue=document.getElementById("themeDark"))==null||ue.addEventListener("click",()=>{document.documentElement.classList.add("dark")});async function P(){ye();const e=j();try{const[t,n,o,s,a,d,p,m,v]=await Promise.all([k(`/api/dashboard-stats?${e}`),k(`/api/conversation-trend?${e}`),k(`/api/team-performance?${e}`),k("/api/zero-replies-conversations"),k(`/api/top-accounts?${e}`),k("/api/team-schedules"),k(`/api/management-kpis?${e}`),k(`/api/management-win-rate?${e}`),k(`/api/management-freight-breakdown?${e}`).catch(()=>null)]);ee=d||{},$e(t),Le(t.quotes),he(n),be(o),Be(s),ke(a),Se(o),Ce(p),ve(m),Te(v)}catch(t){console.error("Load error:",t)}finally{we()}}const z=document.getElementById("searchModal"),W=document.getElementById("searchInput"),_=document.getElementById("searchResults");let ie=null;document.getElementById("searchToggle").addEventListener("click",()=>{z.classList.remove("hidden"),z.classList.add("flex"),W.value="",W.focus(),_.innerHTML='<div class="text-center text-sm text-slate-400 py-12">Type a keyword to search across conversations, messages, quotes, and QRN.</div>'});document.getElementById("searchBack").addEventListener("click",()=>{z.classList.add("hidden"),z.classList.remove("flex")});W.addEventListener("input",()=>{clearTimeout(ie);const e=W.value.trim();if(e.length<2){_.innerHTML='<div class="text-center text-sm text-slate-400 py-12">Type at least 2 characters to search.</div>';return}_.innerHTML='<div class="flex justify-center py-12"><div class="size-6 border-2 border-primary/20 border-t-primary rounded-full animate-spin"></div></div>',ie=setTimeout(()=>Me(e),400)});async function Me(e){try{const t=await k(`/api/search?q=${encodeURIComponent(e)}`);if(!t.length){_.innerHTML='<div class="text-center text-sm text-slate-400 py-12">No results found.</div>';return}const n={subject:"Subject",message:"Message",quote:"Quote",qrn:"QRN"},o={subject:"bg-primary/10 text-primary",message:"bg-amber-100 text-amber-700",quote:"bg-green-100 text-green-700",qrn:"bg-violet-100 text-violet-700"};_.innerHTML=`<p class="text-xs text-slate-400 mb-2">${t.length} result${t.length>1?"s":""}</p>`+t.map(s=>{const a=`${xe}${s.conversation_id}`,d=s.sources.map(m=>`<span class="px-1.5 py-0.5 rounded text-[9px] font-bold uppercase ${o[m]||"bg-slate-100 text-slate-500"}">${n[m]||m}</span>`).join(" "),p=B(s.snippet).replace(new RegExp(`(${e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")})`,"gi"),'<mark class="bg-yellow-200 rounded px-0.5">$1</mark>');return`<a href="${a}" target="_blank" rel="noopener noreferrer" class="block bg-white rounded-xl border border-slate-100 p-4 hover:border-primary/30 hover:shadow-sm transition-all group">
          ...
          <p class="text-xs text-slate-500 line-clamp-2 mb-2">${p}</p>
          <div class="flex items-center gap-1.5">${d}</div>
        </a>`}).join("")}catch(t){console.error("Search error:",t),_.innerHTML='<div class="text-center text-sm text-red-500 py-12">Search failed. Please try again.</div>'}}const ce=document.getElementById("loginOverlay"),T=document.getElementById("loginError"),J=document.getElementById("loginSpinner");function de(e){const t=document.getElementById("authBtn");if(e){if(e.photoURL)t.innerHTML=`<img src="${e.photoURL}" alt="" class="size-10 rounded-full object-cover" referrerpolicy="no-referrer" />`;else{const a=(e.displayName||e.email||"?").split(" ").map(p=>p[0]).join("").substring(0,2).toUpperCase(),d=q(e.displayName||e.email);t.innerHTML=`<span class="size-10 rounded-full flex items-center justify-center text-xs font-bold text-white" style="background:${d}">${a}</span>`}t.title=`Signed in as ${e.email}`;const n=document.getElementById("settingsName"),o=document.getElementById("settingsEmail"),s=document.getElementById("settingsAvatar");n&&(n.textContent=e.displayName||e.email),o&&(o.textContent=e.email),s&&e.photoURL&&(s.innerHTML=`<img src="${e.photoURL}" alt="" class="size-12 rounded-full object-cover" referrerpolicy="no-referrer" />`)}else t.innerHTML='<span class="material-symbols-outlined">login</span>',t.title="Sign in"}fetch(te+"/api/dashboard-stats").catch(()=>{});document.getElementById("googleSignInBtn").addEventListener("click",async()=>{T.classList.add("hidden"),J.classList.remove("hidden");try{await N.signInWithPopup(me)}catch(e){J.classList.add("hidden"),T.textContent=e.code==="auth/popup-closed-by-user"?"":e.message||"Sign-in failed",T.classList.toggle("hidden",!T.textContent)}});document.getElementById("authBtn").addEventListener("click",async()=>{I&&(await N.signOut(),window.location.reload())});N.onAuthStateChanged(async e=>{if(e){if(!e.email.endsWith("@freightright.com")){await N.signOut(),J.classList.add("hidden"),T.textContent="Access restricted to @freightright.com accounts.",T.classList.remove("hidden");return}I=e,S=await e.getIdToken(),de(e),ce.style.display="none",ge("pricing-dashboard"),P()}else I=null,S=null,de(null),ce.style.display="flex"});
